	...
	<div class="container-fluid p-0">
        ...
        <?php
                if(isset($_GET['status']) && $_GET['status']==1){
                    echo "<div class='alert alert-success'>New Auther is successfully created</div>";
                }
            ?>
            <div class="col-md-2">
                ...
                <table class="table" id="myTable">
                    ...
                    <tbody>
                        ...
                        for($r=0;$r<sizeof($auther_list);$r++)
                        {
                            ...
                            echo "<td><a class='btn btn-success mx-2' href='viewAuther.php?id=".$auther_list[$r]['id']."'>View</a><a class='btn btn-warning mx-2 mt-2' href='editAuther.php?id=".$auther_list[$r]['id']."'>Edit</a><a class='mt-2 mx-2 btn btn-danger delete_auther'>Delete</a></td>";
                            echo "</tr>";
